...
def run_cifar10(batch_size,
    ...
    for e in range(nb_epoch):
        ...
        str_template = 'Epoch %s/%s, Time: %s, Train accu: %s, Test accu: %s'
        print(str_template % (e + 1, nb_epoch, time.time() - start,
                              list_train_loss[-1][1], list_test_loss[-1][1]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=64, type=int,
                        help='Batch size')
    parser.add_argument('--nb_epoch', default=256, type=int,
                        help='Number of epochs')
    parser.add_argument('--nb_dense_block', type=int, default=4,
                        help='Number of dense blocks')
    parser.add_argument('--stages', nargs='+', type=int, default=[12, 12, 12, 12],
                        help='Number of layers within each dense block')
